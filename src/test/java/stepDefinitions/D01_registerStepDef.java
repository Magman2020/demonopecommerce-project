...
public class D01_registerStepDef {
    ...
    public void user_push_reg() {
        ...
        Hooks.driver.findElement(By.id("LastName")).sendKeys("Ragab");
        // select Day
        ...
        DateOfBirthYear.selectByValue("2001");

        //insert Email
        Hooks.driver.findElement(By.id("Email")).sendKeys("abc@gmail.com");

        //insert company
        Hooks.driver.findElement(By.id("Company")).sendKeys("ABCDEF");

        //insert pass and confirm pass
        Hooks.driver.findElement(By.id("Password")).sendKeys("ABCD@");
        Hooks.driver.findElement(By.id("ConfirmPassword")).sendKeys("ABCD@");
